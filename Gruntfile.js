...
// Generated on 2013-06-20 using generator-chrome-extension 0.2.2
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    compress: {
      dist: {
        options: {
          archive: 'package/esse3-auto-login-v<%= manifest.version %>.zip'
        },
        files: [
          {
            expand: true,
  ...
  grunt.registerTask('release', function (bump, note) {
    ...
    note = note || '';
    grunt.log.writeln(this.name, bump, note);

    // Bump manifest.json, bower.json, package.json
    grunt.task.run('bumpup:' + bump);
